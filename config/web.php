...
$config = [
    ...
    'components' => [
        'postApi' => [
            'class' => app\components\PostApi::class,
        ],
        'request' => [
            // !!! insert a secret key in the following (if it is empty) - this is required by cookie validation
            'cookieValidationKey' => 'DbEpy5wLeUUsPOvGGgPmO4aSNUmm2orS',
            'parsers' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                [
                    ...
                    'controller' => ['product', 'post-product', 'brand', 'category', 'product-attribute', 'product-variant', 'coupon', 'order', 'cart', 'user-address', 'post', 'tag', 'review'],
